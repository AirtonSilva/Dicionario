...
import br.edu.ifpb.dao.PalavraDAO;
...
public class PalavraBean {
		...
		public String buscar()  {
				...
				List<Palavra> palavras = PalavraDAO.getInstance().getAll();
				
				for (Palavra palavra: palavras) {
					System.out.println(palavra.getId());
					System.out.println(palavra.getPalavra());
					System.out.println(palavra.getSignificado());
				}
